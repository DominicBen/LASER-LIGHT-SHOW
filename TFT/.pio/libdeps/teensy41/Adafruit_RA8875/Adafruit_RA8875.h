...
class Adafruit_RA8875 : public Adafruit_GFX {
 public:
    Adafruit_RA8875(PinName CS, PinName RST, SPI* TFT_SPI);
    ...
    /* Touch screen Calibration addon */
    void    touchCalibrate(void);
    bool    touchReadCal(uint16_t *x, uint16_t *y);
 ...
 private:
    ...
    /* Touch screen Calibration addon */
    int     touchSetCalibrationMatrix( tsPoint_t * displayPtr, tsPoint_t * screenPtr, tsMatrix_t * matrixPtr);
    int     touchCalibrateTSPoint( tsPoint_t * displayPtr, tsPoint_t * screenPtr, tsMatrix_t * matrixPtr);
    void    touchWaitForTouchEvent(tsPoint_t * point);
    tsPoint_t touchRenderCalibrationScreen(uint16_t x, uint16_t y, uint16_t radius);
